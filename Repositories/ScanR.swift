...
class ScanRepository {
    ...
    func applicationStateChanged(_ notification: Notification)-> (State) -> () {
        /*
 ...
 */
        return  {
            ...
            switch appState {
            case .scanning:
                self.scannedObject.isHidden = false
                self.pointCloud.isHidden = false
            default:
                self.scannedObject.isHidden = true
                self.pointCloud.isHidden = true
            }
        }
    }
